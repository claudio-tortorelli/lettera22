...
namespace Lettera22.Common
{
    ...
    public class Executable
    {
        ...
        public Executable(string programFileName, bool createNoWindow, bool useShellExecute)
        {
            ProgramFileName = programFileName;

            _processStartInfo.ErrorDialog = false;
            _processStartInfo.CreateNoWindow = createNoWindow;
        ...
        public int Run(bool bWait = true)
        {
        ...
        public int getPID() { return procId; }
